module qspi_controller_ip#(
	...
	wire		rx_ren 	   =  dma_en ? dma_rx_ren : csr_rx_ren;
	wire [31:0] tx_data_i  =  dma_en ? dma_data_o : csr_data_o;
	wire [31:0] dma_data_i =  dma_en ? rx_data_o  : dma_data_i;
	wire [31:0] csr_data_i = !dma_en ? rx_data_o  : csr_data_i;
	...
	qspi_csr #(.APB_ADDR_WIDTH(APB_ADDR_WIDTH)) csr_inst(
		...
		//[2]
		//CMD_CFG
		.cmd_cmd_lanes_o(cmd_lanes),
		.cmd_addr_lanes_o(addr_lanes),
		.cmd_data_lanes_o(data_lanes),
